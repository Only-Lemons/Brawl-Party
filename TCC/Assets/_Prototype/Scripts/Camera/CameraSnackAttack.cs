...
[ExecuteInEditMode]
public class CameraSnackAttack : MonoBehaviour
{
    public static CameraSnackAttack Singleton;
    Camera cam;
    ...
    void ControleFoco()
    {
        cam.transform.position = new Vector3(Mathf.Lerp(posCam.x, MediaDistancia().x, 2), posCam.y, Mathf.Lerp(posCam.z, MediaDistancia().z + 20, 2));
    }
